...
insert into MEASUREMENT (ID, SENSOR_ID, VALUE, TIMESTAMP) values (5, 2, 55.435, '1990-05-13 07:15:31.123456789');
insert into MEASUREMENT (ID, SENSOR_ID, VALUE, TIMESTAMP) values (6, 2, 1.435, '1990-04-13 07:10:31.123456789');
insert into MEASUREMENT (ID, SENSOR_ID, VALUE, TIMESTAMP) values (7, 2, 12.435, '1990-06-13 07:20:31.123456789');
insert into MEASUREMENT (ID, SENSOR_ID, VALUE, TIMESTAMP) values (8, 2, 44.435, '1990-06-13 07:20:31.123456789');